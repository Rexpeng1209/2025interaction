...
//想把聲音的最重要的頻率找出來使用PitchDetector物件
...
void setup() {
  ...
  pitchDetector = new PitchDetector(this);//新增初始化PitchDetector物件
  // capture audio input
  //pitchDetector.input(new AudioIn(this, 0));//原本程式是用Audio in 音效卡的音源輸出
}
